        ...
        child: Column(
          children: <Widget>[
            ...
            _isEn ? HtmlWidget("""<h1>Terms and Conditions</h1>
              ...
              </ul>""") : HtmlWidget("""<h1>條款和條件</h1>
              <p>最近更新時間: 4月3日，2022年4月</p>
              <p>在使用我們的服務之前，請仔細閱讀這些條款和條件。</p>
              <h1>解釋和定義</h1>
              <h2>解釋</h2>
              <p>首先字母大寫的單詞都具有在以下條件下定義的含義。無論它們是否以奇異或複數出現，以下定義都應具有相同的含義。</p>
              <h2>定義</h2>
              <p>出於這些條款和條件的目的：</p>
              <ul>
              <li>
              ...
              <h1>確認</h1>
              <p>這些是管理本服務的使用條款和條件以及您與公司之間運營的協議。這些條款和條件列出了所有用戶對服務使用的權利和義務。</p>
              <p>您的訪問和使用服務是在接受和遵守這些條款和條件的情況下提供條件。這些條款和條件適用於訪問或使用該服務的所有訪問者，用戶和其他人。</p>
              <p>通過訪問或使用該服務，您同意受這些條款和條件的約束。如果您不同意這些條款和條件的任何部分，那麼您可能無法訪問該服務。</p>
              ...
              <p>我們強烈建議您閱讀您訪問的任何第三方網站或服務的條款和條件和隱私政策。</p>
              <h1>終止</h1>
              <p>我們可以立即終止或暫停您的訪問，恕不另行通知或責任，因為任何原因，如果您違反這些條款和條件，則包括但不限於此。</p>
              <p>終止後，您使用該服務的權利將立即停止。</p>
              <h1>責任限制</h1>
              <p>儘管您可能會造成的任何損害賠償，但在本條款的任何條件下，本公司的全部責任和其所有供應商都應限於您通過服務或100 USD實際支付的金額如果您還沒有通過該服務購買任何東西。</p>
              ...
              <h1>翻譯解釋</h1>
              <p>如果我們在我們的服務中向您提供了這些條款和條件，可能已被翻譯。

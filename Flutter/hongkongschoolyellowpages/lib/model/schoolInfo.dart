...
class SchoolInfo {
  ...
  factory SchoolInfo.fromJson(Map<String, dynamic> json) {
    return SchoolInfo(json['features']);
  }
}
...
class Features {
  ...
  Map? get attributes => this._attributes;

  set attributes(Map? value) => this._attributes = value;

  Features(this._attributes);

  factory Features.fromJson(Map<String, dynamic> json) {
    return Features(json['attributes']);
  }
}
